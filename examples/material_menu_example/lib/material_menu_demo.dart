...
import 'package:kelicap_components/material_menu/affix/caption_affix_model.dart';
import 'package:kelicap_components/material_menu/affix/icon_affix_model.dart';
import 'package:kelicap_components/material_menu/dropdown_menu.dart';
...
class MaterialMenuDemoComponent implements OnDestroy {
  ...
  factory MaterialMenuDemoComponent() {
    ...
    ColorMenuItem Function(
      String, {
      String secondaryLabel,
      MenuModel<MenuItem<dynamic>> subMenu,
    })
    makeColorMenuItem =
        (
          String color, {
    ...
    var menuModelWithIcon = MenuModel<MenuItem>(
      menuModel.itemGroups,
      icon: Icon('menu'),
    );
    ...
    final menuModelWithLongLabels = MenuModel<MenuItem>([
      MenuItemGroup<MenuItem>([
        ...
        MenuItem(
          ...
          subMenu: MenuModel<MenuItem>([
            MenuItemGroup<MenuItem>([
              ...
              MenuItem(
                'Short label',
                secondaryLabel: 'Secondary label that is long enough to wrap',
              ),
            ]),
          ], width: 2),
        ),
        ...
        MenuItem(
          'A long label with a secondary label that should also wrap',
    ...
    disposer.addStreamSubscription(
      typeSelection.changes.listen((_) {
    ...
    disposer.addStreamSubscription(
      planeSelection.changes.listen((_) {
    ...
    var selectableMenuModel = MenuModel<MenuItem>([
      MenuItemGroupWithSelection<String>(
        items: [
          ...
          SelectableMenuItem<String>(
            value: 'Hidden item',
            selectableState: SelectableOption.Hidden,
          ),
          SelectableMenuItem<String>(
            value: 'Sandpaper',
            selectableState: SelectableOption.Disabled,
        ...
        MenuItem(
          ...
          subMenu: MenuModel<MenuItem>([
            MenuItemGroup<MenuItem>([
              ...
              MenuItem('Used', actionWithContext: (_) => window.alert('used!')),
    ...
    final menuModelWithAffixes = MenuModel<MenuItem>([
      MenuItemGroup<MenuItem>([
        ...
        MenuItem(
          ...
          itemSuffixes: ObservableList.from([CaptionAffix(text: 'Ctrl + V')]),
        ),
        MenuItem(
  ...
  ColorMenuItem(
    ...
    String secondaryLabel = '',
         ...
         subMenu: (subMenu != null)
             ? subMenu as MenuModel<ColorMenuItem>
             : null,
         secondaryLabel: secondaryLabel,
