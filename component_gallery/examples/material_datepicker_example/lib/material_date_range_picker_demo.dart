...
import 'package:kelicap_components/material_datepicker/material_date_range_picker.dart';
...
class MaterialDateRangePickerDemoComponent {
  ...
  MaterialDateRangePickerDemoComponent() {
    ...
    range = DatepickerComparison.noComparison(
      _defaultPresets
          .singleWhere((preset) => preset.range.title == 'This week')
          .range,
    );
    rangeSimplified = DatepickerComparison.noComparison(
      _defaultPresets
          .singleWhere((preset) => preset.range.title == 'This week')
          .range,
    );
