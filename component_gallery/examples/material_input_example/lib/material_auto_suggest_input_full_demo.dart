...
import 'package:kelicap_components/material_input/material_auto_suggest_input.dart';
...
class MaterialAutoSuggestInputFullDemoComponent {
  ...
  final suggestionOptions = ExampleSelectionOptions.withOptionGroups(
    _optionGroups,
  );
  ...
  final popupPositionOptions = StringSelectionOptions<String>([
    'Auto',
    'Above',
    'Below',
  ]);
