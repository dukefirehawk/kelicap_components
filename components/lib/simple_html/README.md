...
See the
[component's documentation](https://github.com/dukefirehawk/kelicap_components/blob/master/components/lib/simple_html/simple_html.dart)
...
When the URIs come from a _safe_ source, such as internally sourced URIs, you
...
1. In your template file, bind the message with either:
    ...
    * `<simple-html-block [contents]="msg"></simple-html-block>` rather than
        ...
        required).
1. Verify that it works! See [_Testing_](#testing).
