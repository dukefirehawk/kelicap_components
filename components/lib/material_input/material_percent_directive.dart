...
import 'package:kelicap_components/material_input/material_input_error_keys.dart';

export 'package:kelicap_components/material_input/material_number_accessor.dart'
...
class MaterialPercentInputDirective {
  MaterialPercentInputDirective(
    ...
    final percentLocation = percentPattern.symbols.PERCENT_PATTERN.indexOf(
      percentPattern.symbols.PERCENT,
    );
  ...
  static final _negativePercentageErrMsg = Intl.message(
    ...
    desc:
        'Validation error message when input precentage is negative, it '
        'must be a positive number or zero.'
        '[BACKUP_MESSAGE_ID:4311805941549841920]',
  );

  static final _percentTooSmallErrMsg = Intl.message(
    'Enter a larger number',
    desc:
        'Validation error message for when the input percentage is too '
        'small',
    meaning:
        'Validation error message for when the input percentage is '
        'too small',
  );

  static final _percentTooLargeErrMsg = Intl.message(
