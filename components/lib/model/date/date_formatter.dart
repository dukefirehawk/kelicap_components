...
class _DateFormatterMessages {
  static final _allTimeMsg = Intl.message(
    'All time',
    name: '_allTimeMsg',
  ...
  // Dart implements it)
  static String _formatSameYearRange(
    String month1,
    String day1,
    String month2,
    String day2,
  ...
  static String _formatArbitraryRange(String start, String end) => Intl.message(
    '$start – $end',
    name: '_DateFormatterMessages__formatArbitraryRange',
    desc:
        'Date range containing two arbitrary dates which can fall in '
