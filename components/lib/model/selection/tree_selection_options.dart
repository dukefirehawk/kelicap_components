...
import 'package:kelicap_components/model/selection/tree_selection_mixin.dart';
import 'package:kelicap_components/model/ui/has_renderer.dart';
import 'package:kelicap_components/utils/async/async.dart';

export 'package:kelicap_components/model/selection/tree_selection_mixin.dart';
...
class TreeSelectionOptions<T> extends SelectionOptions<T>
  ...
  TreeSelectionOptions.fromList(
    List<TreeSelectionOptionData<T>> listOfOptions, {
