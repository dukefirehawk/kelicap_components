...
import 'package:kelicap_components/focus/focus_activable_item.dart';
import 'package:kelicap_components/focus/focus_trap.dart';
import 'package:kelicap_components/highlighted_text/highlighted_text.dart';
...
import 'package:kelicap_components/material_menu/menu_item_affix_list.dart';
import 'package:kelicap_components/material_menu/menu_root.dart';
...
import 'package:kelicap_components/model/action/delayed_action.dart';
...
class MenuItemGroupsComponent
  ...
  bool _isSelected(SelectionModel selectionModel, MenuItem item) {
    ...
    return itemValue != null && (selectionModel.isSelected(itemValue));
  }
