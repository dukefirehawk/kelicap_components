...
import 'package:kelicap_components/utils/rate_limit_utils/rate_limit_utils.dart'
...
StreamTransformer<S, T> throttleStream<S, T>(
  Duration duration, {
  bool guaranteeLast = true,
}) => RateLimitTransformer<S, T>(
  duration,
  guaranteeLast ? throttleGuaranteeLast : throttle,
);
