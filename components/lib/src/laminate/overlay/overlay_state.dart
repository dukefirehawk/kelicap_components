...
abstract class OverlayState {
  ...
  static const Dialog = OverlayState(
    captureEvents: true,
    top: 0,
    bottom: 0,
    left: 0,
...
class _ImmutableOverlayState implements OverlayState {
  ...
  @override
  String toString() =>
      'ImmutableOverlayState ${{'captureEvents': captureEvents, 'left': left, 'top': top, 'right': right, 'bottom': bottom, 'width': width, 'height': height, 'visibility': visibility, 'zIndex': zIndex, 'position': position}}';
}
...
class MutableOverlayState implements OverlayState {
  ...
  @override
  String toString() =>
      'MutableOverlayState ${{'captureEvents': captureEvents, 'left': left, 'top': top, 'right': right, 'bottom': bottom, 'width': width, 'minWidth': minWidth, 'height': height, 'zIndex': zIndex, 'visibility': visibility, 'position': position}}';
}
