...
class DateInputDirective implements OnDestroy {
  ...
  DateInputDirective(
    ...
    _disposer.addStreamSubscription(
      _input.onChange.listen(
        (String? input) => _parseDate(input!, setAsCurrent: true),
      ),
    );
  ...
  static final invalidDateMsg = Intl.message(
    'Enter a date',
    name: 'invalidDateMsg',
    meaning: 'Error message',
    desc:
        'Displayed when the user types text into a date input field which '
  ...
  String dateIsTooEarlyMsg(String minimumDate) => Intl.message(
    ...
    meaning: 'Error message',
    desc:
        'Displayed when the user enters a valid date, but it\'s before the '
  ...
  String dateIsTooLateMsg(String maximumDate) => Intl.message(
    ...
    meaning: 'Error message',
    desc:
        'Displayed when the user enters a valid date, but it\'s after the '
