...
import 'package:kelicap_components/model/date/time_zone_aware_clock.dart';

import 'model.dart';

const clockValue = Clock();

const datepickerClock = OpaqueToken(
...
const timeZoneAwareDatepickerModule = Module(
  include: [timeZoneAwareClockModule],
  provide: _sharedClockBindings,
);
