...
class DatepickerPreset {
  ...
  factory DatepickerPreset.thisWeek(
    Clock clock, {
    int? startWeekday,
    List<int>? validStartWeekdays,
  }) {
    startWeekday ??= _defaultStartWeekday;
    validStartWeekdays = _initValidStartWeekdays(
      startWeekday,
      validStartWeekdays,
    );
  ...
  /// [validStartWeekdays] is a list of all starting weekdays which will be
  /// added as [alternatives].
  factory DatepickerPreset.lastWeek(
    Clock clock, {
    int? startWeekday,
    List<int>? validStartWeekdays,
  }) {
  ...
  static String _thisWeekTitle(String startDayName) => Intl.message(
    'This week ($startDayName – Today)',
    name: 'DatepickerPreset__thisWeekTitle',
    desc:
        'Label for a date range corresponding to "this week" starting '
  ...
  static String _thisWeekShortTitle(String startDayName) => Intl.message(
    '$startDayName – Today',
    name: 'DatepickerPreset__thisWeekShortTitle',
    desc:
        'Short label for a date range corresponding to "this week" '
  ...
  static String _lastWeekTitle(String startDayName, String endDayName) =>
      Intl.message(
        'Last week ($startDayName – $endDayName)',
        name: 'DatepickerPreset__lastWeekTitle',
        desc:
            'Label for a date range corresponding to "last week" starting '
  ...
  static String _lastWeekShortTitle(String startDayName, String endDayName) =>
      Intl.message(
        ...
        desc:
            'Short label for a date range corresponding to "last week" '
            'indicating which day of the week is the starting day of the '
