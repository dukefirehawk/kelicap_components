...
[`SelectionOptions`](https://github.com/dukefirehawk/kelicap_components/blob/master/components/lib/model/selection/selection_options.dart)
interface, while what is selected is represented by the
[`SelectionModel`](https://github.com/dukefirehawk/kelicap_components/blob/master/components/lib/model/selection/selection_model.dart)
interface.
...
[`StringSelectionOptions`](https://github.com/dukefirehawk/kelicap_components/blob/master/components/lib/model/selection/string_selection_options.dart)
...
[`SingleSelectionModel`](https://github.com/dukefirehawk/kelicap_components/blob/master/components/lib/src/model/selection/single_selection_model_impl.dart).
...
[`deselectOnActivate`](https://github.com/dukefirehawk/kelicap_components/blob/master/components/lib/material_select/material_dropdown_select.dart?q=deselectOnActivate)
is set to false.
