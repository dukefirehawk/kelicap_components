...
import 'package:kelicap_components/src/laminate/popup/dom_popup_source.dart';
...
const popupModule = Module(include: [overlayModule], provide: _popupProviders);
...
///
/// Should be included at most once per the injection chain.
const popupDebugBindings = [overlayDebugBindings, _popupProviders];
